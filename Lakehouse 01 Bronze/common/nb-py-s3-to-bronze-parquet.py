...
df = spark.read.option("header", "true").option("inferSchema", "true").parquet(f"/Volumes/rocket_mortgage_catalog/00_raw/ingestion/{source_system}/{source_object}/processing/")
...
# MAGIC %sql
# MAGIC select * from rocket_mortgage_catalog.`01_bronze`.test_parfile
